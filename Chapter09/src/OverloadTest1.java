 ...
 * 넓이, 부피 계싼하는 부분은 메소드 오버로딩으로 작성하시오.
...
class Overload {
	...
	public void shape(int width, int height, int depth) {
		...
		System.out.println("육면체의 넓이는 = " + width * height * depth);
	}
}
		...
		while (true) {
			...
			switch (shape_len.length) {
				...
				case 2:
					...
					break;
				case 3:
					// 배열의 길이가 3개이면 0번지와 1번지 2번지 값을 가지고 메소드 호출한다.
