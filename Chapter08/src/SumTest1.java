 ...
 * 문제 : 두 개의 정수를 입력받아 두 수 사이의 모든 합과 짝수의 합, 홀수의 합을 출력하시오.
...
class Sum{
	// 멤버 변수 선언. - 속성
	public int sum;  // 멤버변수는 초기화 필요 없다.
	...
	public int allSum(int num1, int num2) {
		...
		return sum;  // 메소드를 호출한 곳으로 값을 돌려 준다.
	}
...
public class SumTest1 {
	...
	public static void main(String[] args) {
		...
		System.out.print("덧셈을 수행할 두 개의 수 입력(작은 수부터 빈칸으로 입력) : ");
